...
$show="SELECT * FROM  lapout1 WHERE Employee_Code ='$set' ";
...
while($row = $result->fetch_assoc()){
   ...
   <tr><th>MACHINE TYPE</th><td style='font-size:22px;'>" . $row["Machine_Type"]. "</td></tr>
   ...
   <tr><th>SERIAL NO</th><td style='font-size:22px;'>" . $row["Serial_No"]. "</td></tr>";
    ...
    echo "</table>";
        ...
        echo "<table class='myTable' id='table_id' align='center'>
<tr><th>NOC FORM</th><td><form method='GET' action='nocform.php' ><button class='but'>FORM</button></form></td></tr></table>";
}
}
