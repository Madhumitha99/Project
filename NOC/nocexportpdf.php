...
<button type="submit" id="pdf" name="generate_pdf" class="btn btn-primary" style="width:200px;height: 40px;"><i class="fa fa-pdf" aria-hidden="true"></i>
Generate PDF</button>
</form>
</fieldset>
</div>
...
if ($result->num_rows > 0) {
 ...
 while($row = $result->fetch_assoc()) {
        ...
        <td style='font-size:18px;'>" . $row["Time"]. "</td></tr>" ;
