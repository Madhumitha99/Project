...
if (isset($_SESSION['id'])) {
    ...
    $validExt = array ('pdf', 'txt', 'doc', 'docx', 'ppt' , 'zip','png','jpg','xls','xlsx','svg');
    if (empty($file)) {
...
?>
	...
	<div class="form-group">
		...
		<input type="text" name="title" class="form-control"  Placeholder="Enter your full file name" 
               value = "<?php if(isset($_POST['upload'])) { echo $file_title; } ?>" required="">
	</div>

	<div class="form-group">
		<label for="post_tags">SHORT FILE DESCRIPTION</label>
		<input type="text" name="description" class="form-control" Placeholder="Enter your short file name" 
            value="<?php if(isset($_POST['upload'])) { echo $file_description;  } ?>" required="">
	</div>

	 <div class="form-group">
        <label for="post_image">SELECT FILE</label><font color="brown"> (allowed file type: 'pdf','doc','ppt','txt','zip','png','jpg','xls','xlsx','svg' | allowed maximum size: 30 MB ) </font>
        <br><br>
