...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to approve this file?')\"href='?approve=$file_id'><i class='fa fa-times' style='color: red;'></i>Approve</a></td>";
    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to delete this file?')\" href='?del=$file_id'><i class='fa fa-times' style='color: red;'></i>Delete</a></td>";
...
<?php 
 ...
 <h3 class="page-header">
                            <center> <marquee width = 70% ><font color="green" ><?php echo $_SESSION['course']; ?></font><font color="brown"> Files uploaded by various users</font></marquee></center>
                        </h3>
